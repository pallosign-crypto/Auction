...
class TanzaniaAuctions {
    constructor() {
        ...
        this.map = null;
        this.markers = [];
        this.currencyUtils = window.currencyUtils || new CurrencyUtils();
    ...
    updateUIForLoggedInUser() {
        // Update any UI elements for logged-in user
    ...
    initializeCounters() {
        ...
        counters.forEach(counter => {
            ...
            const updateCounter = () => {
                ...
                if (current < target) {
                    if (isCurrency) {
                        counter.textContent = this.currencyUtils.formatTZS(Math.floor(current), false);
                    } else {
                    ...
                    if (isCurrency) {
                        counter.textContent = this.currencyUtils.formatTZS(target, false);
                    } else {
    ...
    updatePriceDisplay(value) {
        ...
        if (display) {
            ...
            display.textContent = this.currencyUtils.formatTZS(price);
        }
    }
        ...
        if (bidHistory) {
            ...
            newBid.innerHTML = `
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-savanna-gold font-bold">${this.currencyUtils.formatTZS(parseInt(bidAmount))}</span>
                </div>
